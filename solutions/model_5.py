...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:51:57.073903Z","iopub.execute_input":"2024-04-04T18:51:57.075766Z","iopub.status.idle":"2024-04-04T18:51:57.083074Z","shell.execute_reply.started":"2024-04-04T18:51:57.075717Z","shell.execute_reply":"2024-04-04T18:51:57.081543Z"}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:51:57.090048Z","iopub.execute_input":"2024-04-04T18:51:57.090581Z","iopub.status.idle":"2024-04-04T18:52:15.660915Z","shell.execute_reply.started":"2024-04-04T18:51:57.090535Z","shell.execute_reply":"2024-04-04T18:52:15.659102Z"}}

# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:52:15.666848Z","iopub.execute_input":"2024-04-04T18:52:15.667479Z","iopub.status.idle":"2024-04-04T18:52:16.744742Z","shell.execute_reply.started":"2024-04-04T18:52:15.667432Z","shell.execute_reply":"2024-04-04T18:52:16.743136Z"}}
import gc
import os
import random
import sys
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:52:16.746610Z","iopub.execute_input":"2024-04-04T18:52:16.748135Z","iopub.status.idle":"2024-04-04T18:54:27.183803Z","shell.execute_reply.started":"2024-04-04T18:52:16.748091Z","shell.execute_reply":"2024-04-04T18:54:27.182536Z"}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.185717Z","iopub.execute_input":"2024-04-04T18:54:27.186357Z","iopub.status.idle":"2024-04-04T18:54:27.216757Z","shell.execute_reply.started":"2024-04-04T18:54:27.186286Z","shell.execute_reply":"2024-04-04T18:54:27.215403Z"}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.218534Z","iopub.execute_input":"2024-04-04T18:54:27.219508Z","iopub.status.idle":"2024-04-04T18:54:27.259317Z","shell.execute_reply.started":"2024-04-04T18:54:27.219447Z","shell.execute_reply":"2024-04-04T18:54:27.258201Z"},"jupyter":{"source_hidden":true}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.261453Z","iopub.execute_input":"2024-04-04T18:54:27.262926Z","iopub.status.idle":"2024-04-04T18:54:27.276835Z","shell.execute_reply.started":"2024-04-04T18:54:27.262799Z","shell.execute_reply":"2024-04-04T18:54:27.275799Z"}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.278711Z","iopub.execute_input":"2024-04-04T18:54:27.279369Z","iopub.status.idle":"2024-04-04T18:54:27.295771Z","shell.execute_reply.started":"2024-04-04T18:54:27.279332Z","shell.execute_reply":"2024-04-04T18:54:27.294693Z"},"jupyter":{"source_hidden":true}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.297571Z","iopub.execute_input":"2024-04-04T18:54:27.298112Z","iopub.status.idle":"2024-04-04T18:54:27.315942Z","shell.execute_reply.started":"2024-04-04T18:54:27.298067Z","shell.execute_reply":"2024-04-04T18:54:27.314226Z"},"jupyter":{"source_hidden":true}}
def lrfn(epoch):
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.317959Z","iopub.execute_input":"2024-04-04T18:54:27.318389Z","iopub.status.idle":"2024-04-04T18:54:27.357261Z","shell.execute_reply.started":"2024-04-04T18:54:27.318355Z","shell.execute_reply":"2024-04-04T18:54:27.355499Z"},"jupyter":{"source_hidden":true}}
def cross_validate_model(train_data, train_data_2, folds, random_seed, targets, nome_modelo):
    ...
    for i, ((train_index, valid_index), (train_index2, valid_index2)) in enumerate(zip(splits1, splits2)):
        ...
        train_gen_2 = DataGenerator(pd.concat([train_data_3_.iloc[train_index_60], train_data_2_.iloc[train_index2]]),
                                    shuffle=True, batch_size=BATCH)
        valid_gen_2 = DataGenerator(pd.concat([train_data_3_.iloc[valid_index_60], train_data_2_.iloc[valid_index2]]),
                                    shuffle=False, batch_size=BATCH * 2, mode='valid')
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.359129Z","iopub.execute_input":"2024-04-04T18:54:27.359615Z","iopub.status.idle":"2024-04-04T18:54:27.376892Z","shell.execute_reply.started":"2024-04-04T18:54:27.359569Z","shell.execute_reply":"2024-04-04T18:54:27.375478Z"},"jupyter":{"source_hidden":true}}
if not ONLY_INFERENCE:
    high_quality_df, low_quality_df = create_train_data()
    result, tempo_execucao, all_oof, all_oof2, all_true, models, score_list, std_dev, path_model = cross_validate_model(
        high_quality_df, low_quality_df, FOLDS, 42, CLASSES, NAME)
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.383995Z","iopub.execute_input":"2024-04-04T18:54:27.384463Z","iopub.status.idle":"2024-04-04T18:54:27.413292Z","shell.execute_reply.started":"2024-04-04T18:54:27.384431Z","shell.execute_reply":"2024-04-04T18:54:27.411723Z"},"jupyter":{"source_hidden":true}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:27.415814Z","iopub.execute_input":"2024-04-04T18:54:27.416435Z","iopub.status.idle":"2024-04-04T18:54:27.432925Z","shell.execute_reply.started":"2024-04-04T18:54:27.416390Z","shell.execute_reply":"2024-04-04T18:54:27.431588Z"},"jupyter":{"source_hidden":true}}
def create_spectogram_competition(spec_id, seconds_min):
    spec = pd.read_parquet(
        f'/kaggle/input/hms-harmful-brain-activity-classification/test_spectrograms/{spec_id}.parquet')
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:28.167448Z","iopub.execute_input":"2024-04-04T18:54:28.167883Z","iopub.status.idle":"2024-04-04T18:54:28.184678Z","shell.execute_reply.started":"2024-04-04T18:54:28.167851Z","shell.execute_reply":"2024-04-04T18:54:28.183108Z"},"jupyter":{"source_hidden":true}}
import tensorflow as tf
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:28.186590Z","iopub.execute_input":"2024-04-04T18:54:28.187099Z","iopub.status.idle":"2024-04-04T18:54:36.197448Z","shell.execute_reply.started":"2024-04-04T18:54:28.187058Z","shell.execute_reply":"2024-04-04T18:54:36.195555Z"}}
# INFER MLP ON TEST
preds = []
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:36.199186Z","iopub.status.idle":"2024-04-04T18:54:36.199870Z","shell.execute_reply.started":"2024-04-04T18:54:36.199547Z","shell.execute_reply":"2024-04-04T18:54:36.199576Z"},"jupyter":{"source_hidden":true}}
...
# %% [code] {"execution":{"iopub.status.busy":"2024-04-04T18:54:36.203249Z","iopub.status.idle":"2024-04-04T18:54:36.204664Z","shell.execute_reply.started":"2024-04-04T18:54:36.204362Z","shell.execute_reply":"2024-04-04T18:54:36.204402Z"},"jupyter":{"source_hidden":true}}
